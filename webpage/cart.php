											...
											<div class="mini-cart-brief text-left">
												...
												<div class="all-cart-product clearfix">
													<div class="single-cart clearfix">
														...
														<div class="cart-info">
															<h5><a href="#">Proprietary Table Lamp</a></h5>
																...
																<td class="product-thumbnail  text-left">
																	...
																	<div class="single-product">
																		...
																		<div class="product-info">
																			<h4 class="post-title"><a class="text-light-black" href="#">Brown Fur Sofa</a></h4>
															...
															<tr>
																<td class="product-thumbnail  text-left">
																	...
																	<div class="single-product">
																		...
																		<div class="product-info">
																			<h4 class="post-title"><a class="text-light-black" href="#">Kitchen Table Set</a></h4>
																			<p class="mb-0">Color :  Black</p>
																			<p class="mb-0">Size :     SL</p>
																		</div>
																	</div>
															...
															<tr>
																<td class="product-thumbnail  text-left">
																	...
																	<div class="single-product">
																		...
																		<div class="product-info">
																			<h4 class="post-title"><a class="text-light-black" href="#">Green fur Sofa</a></h4>
																			<p class="mb-0">Color :  Black</p>
																			<p class="mb-0">Size :     SL</p>
																		</div>
																	</div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="single-footer">
                                    ...
                                    <ul class="footer-contact">
                                        ...
                                        <li><span>Email :</span>hrust@gmail.com</li>
                                    </ul>
                                </div>
                            </div>
